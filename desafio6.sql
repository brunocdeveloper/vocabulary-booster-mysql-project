...
INNER JOIN jobs AS tableJobs ON tableJobs.JOB_ID = tableEmployees.JOB_ID
INNER JOIN job_history AS tableHistory ON tableHistory.EMPLOYEE_ID = tableEmployees.EMPLOYEE_ID
INNER JOIN departments AS tableDepartments ON tableDepartments.DEPARTMENT_ID = tableEmployees.DEPARTMENT_ID
